	...
	: ui(new Ui::About)
{
	...
	ui->version->setText("Version 1.0.0");
	ui->author->setText("Erik van Haeringen");
	ui->link->setText("<a href=\"https://github.com/esvanhaeringen/annotateVideoEmotion\">https://github.com/esvanhaeringen/annotateVideoEmotion\</a>");
